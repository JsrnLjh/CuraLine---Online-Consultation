              ...
              <div className="card">
                ...
                <div className="period-stats">
                  ...
                  <div className="period-item">
                    ...
                    <div className="period-value">{stats.consultations.week}</div>
                  </div>
                  <div className="period-item">
                    <div className="period-label">This Month</div>
                    <div className="period-value">{stats.consultations.month}</div>
                  </div>
                  <div className="period-item">
                    <div className="period-label">This Year</div>
                    <div className="period-value">{stats.consultations.year}</div>
                  </div>
                </div>
              </div>
            ...
            <div className="section-grid">
              <div className="card">
                ...
                <div className="chart-list">
                  {stats.byDoctor.map((item, index) => (
                    <div key={index} className="chart-item">
                      <div className="chart-label">{item.doctorName}</div>
                      <div className="chart-bar-container">
                        <div 
                          className="chart-bar" 
                          style={{ 
                            width: `${stats.consultations.total > 0 ? (item.count / stats.consultations.total) * 100 : 0}%` 
                          }}
                        />
                      </div>
              ...
              <div className="card">
                <h2>Consultations by Specialty</h2>
                <div className="chart-list">
                  {stats.bySpecialty.map((item, index) => (
                    <div key={index} className="chart-item">
                      <div className="chart-label">{item.specialty}</div>
                      <div className="chart-bar-container">
                        <div 
